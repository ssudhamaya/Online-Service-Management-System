...
<div class="col-sm-6 mt-5 mx-3">
  ...
  if(isset($_REQUEST['checkid']) && !empty($_REQUEST['checkid'])) {
   ...
   if($row){
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr>
                ...
                <td><?php if(isset($row['electronics_type'])){echo $row['electronics_type'];} ?></td>
            </tr>
            <tr>
                <td>Request Info</td>
    ...
    <?php } } else { 
     echo '<div class="alert alert-info mt-4" style="font-weight:bold; font-size:20px;">Your Request is Still Pending</div>';
    }
 }?>
