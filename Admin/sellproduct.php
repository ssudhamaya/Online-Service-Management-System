...
if(isset($_REQUEST['psubmit'])){
 if(($_REQUEST['cname'] == "") || ($_REQUEST['cadd'] == "") || ($_REQUEST['pname'] == "") || ($_REQUEST['pbrand'] == "") || ($_REQUEST['pquantity'] == "") || ($_REQUEST['psellingcost'] == "") || ($_REQUEST['totalcost'] == "") || ($_REQUEST['selldate'] == "")){
  ...
  $cpbrand = $_REQUEST['pbrand'];
  $cpquantity = $_REQUEST['pquantity'];
  $cpeach = $_REQUEST['psellingcost'];
  $cptotal = $_REQUEST['totalcost'];
  $cpdate = $_REQUEST['selldate'];
  $sql = "INSERT INTO customer_tb (custname, custadd, cpname, cpbrand, cpquantity, cpeach, cptotal, cpdate) VALUES ('$custname', '$custadd', '$cpname', '$cpbrand', '$cpquantity', '$cpeach', '$cptotal', '$cpdate')";
  ...
  ?>
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="pbrand" name="pbrand" value="<?php if(isset($row['pbrand'])) {echo $row['pbrand']; }?>">
        </div>
        <div class="form-group">
