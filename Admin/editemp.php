...
if(isset($_REQUEST['empupdate'])){
  if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")){
   ...
   $sql = "UPDATE technician_tb SET empName = '$eName', empSpec = '$eSpec', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 ?>
    <form action="" method="POST">
        ...
        <div class="form-group">
            <label for="empId">Emp Specialization</label>
            <input type="text" class="form-control" id="empSpec" name="empSpec" value="<?php if(isset($row['empSpec'])) {echo $row['empSpec']; }?>">
        </div>
        <div class="form-group">
