...
if(isset($_REQUEST['pupdate'])){
  if(($_REQUEST['pname'] == "") || ($_REQUEST['pbrand'] == "") || ($_REQUEST['pdop'] == "") || ($_REQUEST['pava'] == "") || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == "")){
    ...
    $sql = "UPDATE assets_tb SET pname = '$pname', pbrand = '$pbrand', pdop = '$pdop', pava = '$pava', ptotal = '$ptotal', poriginalcost = '$poriginalcost', psellingcost = '$psellingcost' WHERE pid = '$pid'";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  ?>
    <form action="" method="POST">
        ...
        <div class="form-group">
            <label for="pbrand">Product ID</label>
            <input type="text" class="form-control" id="pbrand" name="pbrand" value="<?php if(isset($row['pbrand'])) {echo $row['pbrand']; }?>" readonly>
        </div>
        <div class="form-group">
