...
<div class="col-sm-4 mb-5">
    <?php 
  $sql = "SELECT request_id, electronics_type, request_info, request_desc, request_date FROM submitrequest_tb";
   ...
   while($row = $result->fetch_assoc()){
    echo '<div class="card mt-5 mx-5">';
     ...
     echo '<div class="card-body">';
      echo '<h5 class="card-title">Type: '.$row['electronics_type'];
      echo '</h5>';
       echo '<h5 class="card-title">Info: '.$row['request_info'];
      echo '</h5>';
